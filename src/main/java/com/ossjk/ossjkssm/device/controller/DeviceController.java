...
import com.ossjk.ossjkssm.common.Change;
...
public class DeviceController extends BaseController{
	...
	public Object insert(Device device) {
		device.setCode(Change.creadLS(deviceService.selectCode().getCode()));
		device.setSno(Change.creadDJS(deviceService.selectCode().getSno()));
