			...
			<div class="panel mt-20">
				<div class="panel-body">
					<div class="clearfix">
						...
						<a href="javascript:;" onclick="insert('添加','${pageContext.request.contextPath}/device/device/toInsert.do','800','500')" class="btn btn-primary radius"> <i class="Hui-iconfont">&#xe600;</i> 添加
						</a>
							...
							<tbody class="getData-list" data-currPage='1'>
								<c:forEach items="${requestScope.page.records }" var="record">
									<tr class="text-c">
										...
										<td><fmt:formatDate value="${record.proddate }" pattern="yyyy-MM-dd"/></td>
										<td>${record.cname }</td>
										<td><fmt:formatDate value="${record.createtime }" pattern="yyyy-MM-dd hh:mm:ss"/></td>
										<td>${record.bname }</td>
										<td><fmt:formatDate value="${record.bugdate }" pattern="yyyy-MM-dd"/></td>
										<td class="f-14 td-manage">
										<td class="f-14 td-manage">
										<a title="编辑" href="javascript:;" onclick="update('编辑','${pageContext.request.contextPath}/device/device/toUpdate.do?&id=${record.id }','1','800','500')" class="ml-5" style="text-decoration: none"><i class="Hui-iconfont">&#xe6df;</i></a>
