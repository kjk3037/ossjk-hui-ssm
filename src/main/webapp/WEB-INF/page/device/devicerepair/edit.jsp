				...
				<form action="${pageContext.request.contextPath}${requestScope.record != null ?  '/device/devicerepair/update.do' :'/device/devicerepair/insert.do'}" method="post" class="form form-horizontal" id="form">
					...
					<div class="row clearfix">
						...
						<div class="formControls col-xs-8 col-sm-9">
							...
							<select id="damager" name="damager">
					...
					<div class="row clearfix">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input class="input-text" id="damagedate" name="damagedate" <c:if test="${requestScope.records != null }">type="text"</c:if> <c:if test="${requestScope.records == null }">type="date"</c:if> >
						</div>
					</div>
					<div class="row clearfix">
						<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>报修备注：</label>
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" id="damageremarks" name="damageremarks" value="${record.damageremarks }">
						</div>
					</div>
					<div class="row clearfix">
