			...
			<div class="panel mt-20">
				<div class="panel-body">
					<div class="clearfix">
						...
						<a href="javascript:;" onclick="insert('添加','${pageContext.request.contextPath}/device/devicereceive/toInsert.do','800','500')" class="btn btn-primary radius"> <i class="Hui-iconfont">&#xe600;</i> 添加
						</a>
							...
							<tbody class="getData-list" data-currPage='1'>
								<c:forEach items="${requestScope.page.records }" var="record">
									<tr class="text-c">
										...
										<td><fmt:formatDate value="${record.receivedate }" pattern="yyyy-MM-dd"/></td>
										...
										<c:if test="${record.status eq 1 }"><a class="btn btn-primary" title="归还" href="javascript:;" onclick="toback('归还','${pageContext.request.contextPath}/device/devicereceive/toback.do?&id=${record.id }','1','800','500')">归还</a></c:if>
										<a title="编辑" href="javascript:;" onclick="update('编辑','${pageContext.request.contextPath}/device/devicereceive/toUpdate.do?&id=${record.id }','1','800','500')" class="ml-5" style="text-decoration: none"><i class="Hui-iconfont">&#xe6df;</i></a>
										<a title="删除" href="javascript:;" onclick="del(this,'${pageContext.request.contextPath}/device/devicereceive/delete.do?&id=${record.id}')" class="ml-5" style="text-decoration: none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
										</td>
									</tr>
								</c:forEach>
